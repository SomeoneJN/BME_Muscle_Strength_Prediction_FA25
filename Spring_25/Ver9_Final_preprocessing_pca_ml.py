...
for t in ML_TARGETS:
    ...
    for cols, label in combos:
        ...
        # Single PC group (exactly one group, not All PCs, not double)
    ...
    print(f"\n{t}:")
    print(f"  Best Single PCA: {best_single:16s} \n  | R2 = {best_single_r2:.3f} | MSE = {single_mse:.5f} |")
    print(f"  Best Double PCA: {best_double:16s} \n  | R2 = {best_double_r2:.3f} | MSE = {double_mse:.5f} |")
    print(f"  All  groups PCA: {'All PCs':16s}   \n  | R2 = {all_3_PCA_s_r2:.3f} | MSE = {all_mse:.5f} |")
