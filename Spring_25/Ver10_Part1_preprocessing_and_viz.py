# -*- coding: utf-8 -*-
"""
Created on Mon Jun  2 05:13:22 2025

@author: nerij

Ver10_Part1_preprocessing_and_viz.py

Handles: splitting, noise, PCA, all visualizations.
"""
...
INNER_Y_NOISE_RANGE = (-0.01, 0.01)   # (min, max) noise for inner_y
INNER_Z_NOISE_RANGE = (-0.01, 0.01) # (min, max) noise for inner_z

num_examples = 9  # Set this to any value you want (e.g., 6, 9, 12, etc.)
...
# --- Inner Shape (Perfect Circle) Visualization ---
...
# --- Outer Shape (Perfect Circle) Visualization ---
...
# Save all intermediate products for part 2!
