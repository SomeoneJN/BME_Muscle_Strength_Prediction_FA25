# -*- coding: utf-8 -*-
"""
Created on Mon Jun  2 05:14:53 2025

@author: nerij

Ver10_Part2_ml_and_results.py

Handles: ML, model selection/report, prediction plots, percent error, chained prediction.
"""
...
# --- ML Loop, PREDICTION VS ACTUAL, Percent Error Plots ---
results = {}
for target in ML_TARGETS:
    ...
    # --- PREDICTIONS VS ACTUAL plot for best ---
...
# ==== CHAINED PREDICTION FOR Part1_E (robust, with percent error) ====
...
# Predict Part3_E, Part11_E on test data
...
# Plot: True vs Predicted P3/P11 as extra features
plt.figure(figsize=(7, 5))
...
# Percent error plots for chained prediction
